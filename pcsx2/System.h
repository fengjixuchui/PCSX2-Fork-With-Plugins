...
namespace HostMemoryMap
{
	...
	static const u32 bumpAllocatorOffset = 0x10000000 + _128mbOffset;

	//////////////////////////////////////////////////////////////////////////
	// Code
	//////////////////////////////////////////////////////////////////////////
	static const u32 CodeSize = 0x13100000 + _128mbOffset;

	// EE recompiler code cache area (64mb)
	static const u32 EErecOffset   = 0x00000000;

	// IOP recompiler code cache area (32mb)
	static const u32 IOPrecOffset  = 0x04000000 + _128mbOffset;

	// newVif0 recompiler code cache area (8mb)
	static const u32 VIF0recOffset = 0x06000000 + _128mbOffset;

	// newVif1 recompiler code cache area (8mb)
	static const u32 VIF1recOffset = 0x06800000 + _128mbOffset;

	// microVU1 recompiler code cache area (64mb)
	static const u32 mVU0recOffset = 0x07000000 + _128mbOffset;

	// microVU0 recompiler code cache area (64mb)
	static const u32 mVU1recOffset = 0x0B000000 + _128mbOffset;

	// SSE-optimized VIF unpack functions (1mb)
	static const u32 VIFUnpackRecOffset = 0x0F000000 + _128mbOffset;

	// Software Renderer JIT buffer (64mb)
	static const u32 SWrecOffset = 0x0F100000 + _128mbOffset;
